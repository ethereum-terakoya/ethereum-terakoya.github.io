      ...
      e.exports = function (e) {
        var t = e.scope,
          ...
          p = u.useMemo(
            function () {
              if (!n) return null;
              var e = l({ React: u, mdx: s }, i),
                t = Object.keys(e),
                o = t.map(function (t) {
                  return e[t];
                });
              return r(Function, ["_fn"].concat(a(t), ["" + n])).apply(
                void 0,
                [{}].concat(a(o))
              );
            },
...
//# sourceMappingURL=component---src-templates-post-js-1a063fa50a8da13688b7.js.map
