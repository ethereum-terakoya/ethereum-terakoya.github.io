...
<div class="blog-block">
  <ul>
    <li>
      <a href="/pdf/eth2.0/Eth2_Data_Sharding_en.pdf" target="_blank">
        Eth2 Data Sharding
      </a>
    </li>
    <li>
      <a href="/pdf/eth2.0/What's RU_en.pdf" target="_blank">
        What is a Rollup？
      </a>
    </li>
  </ul>
...
<div style="padding-left: 1em;margin-left: 1em;">
  These numbers are for reference only. However, significant improvements are
  expected due to Rollups and Data Sharding.
</div>
