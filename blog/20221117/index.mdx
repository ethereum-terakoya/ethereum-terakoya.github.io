...
<br />
日立製作所 高橋さんからは、PBI（公開型生体認証基盤）を活用した実店舗での指静脈認証決済の動画デモや、スクウェア・エニックス 畑さんからはNFTゲーム事業化における苦労や工夫が発表され、まさにブロックチェーンの実用の最前線を垣間見ることができるセッションとなりました。ファシリテーターを交えたディスカッションでは、会場参加者からも多くの質問が挙げられました。
<br />
<br />
