...
2. Main topics <br/>
   The latest trend of zero-knowledge proofs in Ethereum ｜ Presenter: Barry Whitehat <br/>
   2.1. How to build a private social network <br/>
   2.2. Zero-knowledge proof <br/>
...
#### 2-1. How to build a private social network
