...
<div class="blog-block">
  <ul>
    <li>
      <a
        href="https://youtu.be/En0PL7pOhlA"
        target="_blank"
      >
        Performance Evaluation Perspectives for Business Use of Blockchain Ethereum Performance Evaluation Workshop 【ETHTerakoya × Blockchain EXE 】10/29/2021
      </a>
    </li>
  </ul>
  <p class="sub">
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-0【Opening】20211029Workshop.pdf"
    target="_blank"
...
We have also prepared a <a href="https://github.com/ethereum-terakoya/perfomance-test-white-paper" target="_blank">white paper</a> as a deliverable, which we sincerely encourage you to utilize.
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-2【Accenture】Sharing_Performance_Verification_Results_in_the_Future_of_Productions_System .pdf"
    target="_blank"
    style="margin-left: 5px"
  >
    here
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-3【Couger】Items_to_be_described_as_performance_measurement_conditions_and_results.pdf"
    target="_blank"
    style="margin-left: 5px"
  >
    here
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-4【HITACHI】Blockchain_Benchmark_Tools.pdf"
    target="_blank"
    style="margin-left: 5px"
  >
    here
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-5【NTT-TX】Performance_Assessment_of_Besu_with_Hyperledger_Caliper.pdf"
    target="_blank"
    style="margin-left: 5px"
  >
    here
...
<p style="text-align: right;font-weight:bold;">
  Download the file
  <a href="/pdf/scaling8/【NTTD】Quorum性能検証について.pdf" target="_blank" style="margin-left: 5px">
    here
  </a>
</p>
...
![第1回ブロックチェーンスケーリングに関するワークショップ](./images/img6.png)

<p style="text-align: right;font-weight:bold;">
  Download the file
  <a
    href="/pdf/scaling8/8-7【SingulaNet】Blockchain_Infrastructure_in_the_Digital_Contents_Field.pdf"
    target="_blank"
    style="margin-left: 5px"
  >
    here
