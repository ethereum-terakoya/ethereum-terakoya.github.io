...
![2021年6月-8月ブロックチェーンにおけるスケーリング指標策定ワークショップ計画書](./images/section1_en.png)

<p style="text-align: right;font-weight:bold;">
  <a href="/pdf/scaling/E-ETHTerakoya_Overview-scaling_v006_en.pdf" target="_blank">
    Download
  </a>
</p>
...
![第1回ブロックチェーンスケーリングに関するワークショップ](./images/section2_en.png)
