      ...
      var i = function (t, e) {
        ...
        v = function (t, e) {
          ...
          (n = c(t, f, e)),
            ...
            p || window.webVitals.firstInputPolyfill(d),
            o(function () {
              (f = i("FID")),
                (n = c(t, f, e)),
        ...
        l = function (t, e) {
          var n,
            ...
            p = a("largest-contentful-paint", d);
          if (p) {
            n = c(t, f, e);
            var v = function () {
              u.has(f) ||
                (p.takeRecords().map(d), p.disconnect(), u.add(f), n());
            };
            ["keydown", "click"].forEach(function (t) {
              addEventListener(t, v, { once: !0, capture: !0 });
            }),
              r(v, !0),
              o(function (a) {
                (f = i("LCP")),
...
//# sourceMappingURL=13-36470b6ccccd467bde9c.js.map
