  ...
  [0],
  {
    ...
    Bl7J: function (e, t, n) {
      ...
      (pe.defaultProps = {
        ...
        (pe.Text = de);
      var me = pe,
        ve = (n("K9S6"), a.a.createContext(null));
      ve.displayName = "CardContext";
      var be = ve,
      ...
      Te.defaultProps = { disabled: !1 };
      var Re = Te,
        Ie = { disabled: !1, as: Se.a },
      ...
      (Ae.displayName = "NavLink"), (Ae.defaultProps = Ie);
      var Le = Ae,
      ...
      function Ze(e) {
        return e instanceof _e(e).Element || e instanceof Element;
      }
      function Ge(e) {
        return e instanceof _e(e).HTMLElement || e instanceof HTMLElement;
      }
      function Xe(e) {
        return ["table", "td", "th"].indexOf(Qe(e)) >= 0;
      }
      function Je(e) {
        return (Ze(e) ? e.ownerDocument : e.document).documentElement;
      }
      function $e(e) {
        return "html" === Qe(e)
          ? e
      ...
      function et(e) {
        if (!Ge(e) || "fixed" === Ye(e).position) return null;
        var t = e.offsetParent;
        if (t) {
          var n = Je(t);
          if (
            "body" === Qe(t) &&
            "static" === Ye(t).position &&
            "static" !== Ye(n).position
          )
            return n;
        }
        return t;
      ...
      function tt(e) {
        for (
          var t = _e(e), n = et(e);
          n && Xe(n) && "static" === Ye(n).position;

        )
          n = et(n);
        return n && "body" === Qe(n) && "static" === Ye(n).position
          ? t
          : n ||
              (function (e) {
                for (
                  var t = $e(e);
                  Ge(t) && ["html", "body"].indexOf(Qe(t)) < 0;
      ...
      function bt(e) {
        ...
        if (c) {
          ...
          h === _e(n) && (h = Je(n)),
            a === it &&
              ((v = st), (f -= h.clientHeight - r.height), (f *= s ? 1 : -1)),
            a === lt &&
              ((m = ct), (u -= h.clientWidth - r.width), (u *= s ? 1 : -1));
        }
        var g,
          y = Object.assign({ position: i }, c && vt);
        return s
          ? Object.assign(
              Object.assign({}, y),
              {},
      ...
      function kt(e, t) {
        void 0 === t && (t = []);
        var n = (function e(t) {
            return ["html", "body", "#document"].indexOf(Qe(t)) >= 0
        ...
        var r =
            "clippingParents" === t
              ? (function (e) {
                  var t = kt($e(e)),
                    n =
                      ["absolute", "fixed"].indexOf(Ye(e).position) >= 0 &&
                      Ge(e)
                        ? tt(e)
                        : e;
                  return Ze(n)
                    ? t.filter(function (e) {
                        return Ze(e) && He(e, n) && "body" !== Qe(e);
                      })
                    : [];
                })(e)
              : [].concat(t),
      ...
      function It(e, t) {
        ...
        var n = t,
          ...
          p = n.padding,
          m = void 0 === p ? 0 : p,
          v = at("number" != typeof m ? m : ot(m, ut)),
          b = "popper" === u ? "reference" : "popper",
          h = e.elements.reference,
          g = e.rects.popper,
          y = e.elements[d ? b : u],
          O = Mt(Ze(y) ? y : y.contextElement || Je(e.elements.popper), i, c),
          x = jt(h),
          w = Rt({
            reference: x,
            element: g,
          ...
          j = "popper" === u ? E : x,
          N = {
            top: O.top - j.top + v.top,
            bottom: j.bottom - O.bottom + v.bottom,
            left: O.left - j.left + v.left,
            right: j.right - O.right + v.right,
          },
      ...
      var Kt = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            i = It(t, { elementContext: "reference" }),
          ...
          if (w) {
            if (o) {
              var P = "y" === O ? it : lt,
                ...
                z = K[k],
                W = rt(0, E[S], B[S]),
                U = y ? E[S] / 2 - R - W - q - N : I - W - q - N,
                V = y ? -E[S] / 2 + R + W + z + N : A + W + z + N,
                ...
                Q = w[O] + U - _ - H,
                Y = w[O] + V - _,
                Z = rt(p ? Math.min(M, Q) : M, D, p ? Math.max(T, Y) : T);
              (w[O] = Z), (C[O] = Z - D);
            }
            if (s) {
              var G = "x" === O ? it : lt,
      ...
      var Qt = _t({ defaultModifiers: [Kt, zt, ht, yt, qt, At, Wt, mt] }),
        Yt = function (e) {
          return {
            position: e,
            top: "0",
      ...
      var Jt = function (e, t, n) {
        var a = void 0 === n ? {} : n,
          ...
          p = a.modifiers,
          m = void 0 === p ? Xt : p,
          v = Object(u.a)(a, ["enabled", "placement", "strategy", "modifiers"]),
          b = Object(r.useRef)(),
      ...
      function on(e) {
        ...
        var C,
          ...
          T = { show: h, alignEnd: g, hasShown: i.current, close: y };
        return (
          (C = b
            ? Object(l.a)({}, D, T, {
      ...
      (bn.displayName = "DropdownItem"), (bn.defaultProps = vn);
      var hn = bn;
      function gn(e, t) {
        return e;
      }
      ...
      var xn = a.a.forwardRef(function (e, t) {
        var n,
          o,
          i = e.bsPrefix,
          s = e.className,
          ...
          x = Object(r.useContext)(ne),
          w = Object(y.a)(i, "dropdown-menu"),
          E =
            ((n = Object(r.useRef)(null)),
            ...
            [
              Object(r.useCallback)(function (e) {
                e &&
                  (yn(e, "popover") || yn(e, "dropdown-menu")) &&
                  ((o.current = On(e)),
                  (e.style.margin = "0"),
                  (n.current = e));
              }, []),
                  ...
                  return {
                    ...
                    effect: function (e) {
                      ...
                      if (
                        n.current &&
                        t.elements.arrow &&
                        yn(n.current, "popover") &&
                        t.modifiersData["arrow#persistent"]
                      ) {
                        var r = On(t.elements.arrow),
                          a = r.top,
                          o = r.right,
                          i = a || o;
                        return (
          ...
          T = C.props;
        return (
          (T.ref = xe(j, xe(gn(t), T.ref))),
          P || v
            ? ("string" != typeof h &&
                ((T.show = S), (T.close = M), (T.alignRight = D)),
              k &&
                ((O.style = Object(l.a)({}, O.style, {}, T.style)),
                (O["x-placement"] = k)),
              a.a.createElement(
                h,
                Object(l.a)({}, O, T, {
                  className: d()(s, w, S && "show", D && w + "-right"),
                })
              ))
            : null
        );
      ...
      (xn.displayName = "DropdownMenu"),
        (xn.defaultProps = { alignRight: !1, flip: !0 });
      var wn = xn,
        En =
          (n("BO/t"),
          a.a.forwardRef(function (e, t) {
      ...
      var jn = En,
        Nn = x("dropdown-header", { defaultProps: { role: "heading" } }),
        Cn = x("dropdown-divider", { defaultProps: { role: "separator" } }),
        Pn = x("dropdown-item-text", { Component: "span" }),
        kn = a.a.forwardRef(function (e, t) {
      ...
      (kn.displayName = "Dropdown"),
        ...
        (kn.Toggle = jn);
      var Sn = kn,
        Dn = a.a.forwardRef(function (e, t) {
          var n = e.id,
            r = e.title,
            o = e.children,
            i = e.bsPrefix,
      ...
      (Dn.displayName = "NavDropdown"),
        (Dn.Item = Sn.Item),
        (Dn.ItemText = Sn.ItemText),
        (Dn.Divider = Sn.Divider),
        (Dn.Header = Sn.Header);
      var Mn = Dn,
        Tn = function () {
          var e = Object(o.a)();
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(Mn.Item, { href: "/" }, "日本語"),
                      a.a.createElement(Mn.Item, { href: "/en" }, "English")
                    )
                  )
                )
              )
...
//# sourceMappingURL=commons-181350a34cf6d7a70141.js.map
