    ...
    pageContext.locale === "ja"
      ? [
          // jp
          {
            ...
            description:
              "2022年11月17日、EEA Japan（エンタープライズ・イーサリアム・アライアンス・ジャパン）主催による「【スクエニ、日立が語る】ゲームxNFT、Web3x分散型IDによるブロックチェーン事業の最前線」を開催しました。",
          },
          {
            date: "2022年7月13日",
            title: "お知らせ",
...
export const query = graphql`
  query {
    image1: file(relativePath: { eq: "event-image.jpg" }) {
      childImageSharp {
        fixed(width: 250) {
    ...
    image2: file(relativePath: { eq: "eea_hitachi_squeni.png" }) {
      childImageSharp {
        fixed(width: 250) {
          ...GatsbyImageSharpFixed
        }
